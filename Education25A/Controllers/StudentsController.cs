...
namespace Education25A.Controllers
{
    public class StudentsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,LastName,FirstName,FatherName,TotalIncome,IncomeEvidence,StudentAddress,StudentCity,StudentProvince,ContactNumber,DateOfBirth")] Students students)
        {
            if (ModelState.IsValid)
            {
